...
public class Oop4 {
    public static void main(String[] args) throws Exception {
        ...
        exampleClass1.publicVaraiable = "public";
        ...
        // chapter3etc 패키지에 선언된 ExampleVlass1의 defaultVariable 필드는
        ...
        User user = new User("Jhon", 20, "email@email.com");
...
class ExampleClass2 extends ExampleClass1{
    ...
    ExampleClass2(){
        // ExampleClass1에 protected로 지정되어있는 protectedVariable을
...
class User{
    ...
    // 특정 필드의 데이터를 반환화는 public 접근 제어자의 getter 메서드가 필요함
    ...
    // setter 메서드가 반드시 필요함
    // 인스턴스의 데이터가 변경이 이루어져야 한다면 특정 필드에 대한 setter 메서드만
    // 만들어주는 것이 좋음
...
class Board {
    ...
    public String getBoardWriteDateTime() {
        return this.boardWriteDateTime;
    }
