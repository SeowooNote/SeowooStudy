...
// static : 해당 멤버(필드 / 메서드)를 JVM의 메서드영역에 할당하여 모든 곳에서 사용이 가능하도록 하는 제어자
// 클래스로 해당 멤버를 접근할 수 있도록 함
// 메소드, 변수에서 사용 가능
class StaticClass{
...
public class Oop5 {
    public static void main(String[] args) throws Exception {
        // stati으로 선언된 변수 혹은 메서드는 클래스 자체로 접근할 수 있음
