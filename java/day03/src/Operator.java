public class Operator {
    public static void main(String[] args) throws Exception {
        ...
        // != (부들 비교 연산자) : 좌항이 우항과 다른지를 비교, 다르면 true 아니면 false
        ...
        // < (작다 비교 연산자) : 좌항이 우항보다 작은지 비교, 작다면 ture 아니면 false
        result = number4  < number5;
        System.out.println(result);
        ...
        // || (논리 OR 연산자) : 좌항과 우항 중 하나라도 true 이면 true를 반환
        result = trueFlag || trueFlag;
        System.out.println(result);
        result = trueFlag || falseFlag;
        System.out.println(result);
        ...
        //  ! (논리 NOT 연산자) : 우항의 논리 값을 반전 시킴, true면 false, false면 true
        result = !trueFlag;
        System.out.println(result);
    }
}
