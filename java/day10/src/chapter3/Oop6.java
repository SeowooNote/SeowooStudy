...
// 추상 클래스
// 추상 메서드가 포함되어 있는 클래스
// 추상 메서드 : 선언부만 정의가 되어 있고 구현부는 작성되지 않은 메서드
// 추상 클래스로는 인스턴스를 생성할 수 없음, 반드시 추상 클래스를 확장해서 사용해야 함
// 추상 클래스를 확장한 하위 클래스는 반드시 추상 메서드를 오버라이드 한 후 구현해야 함
...
abstract class Animal{
    ...
    public Animal(int legCount, boolean hasWing) {
...
class Dog extends Animal{
    ...
    public Dog(int legCount, boolean hasWing) {
