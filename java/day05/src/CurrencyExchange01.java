// 사용자로부터 콘솔을 통해 환전하고자하는 화폐탄위를 입력받는다.
// 화페단위를 입력 받은 후 환전할 원화 금액을 입력받는다.
// 해당하는 화페단위의 환율에 따라 환전된 원화 금액을 출력한다.
...
public class CurrencyExchange01 {
    public static void main(String[] args) throws Exception {
        ...
        // if(monetaryUnit.equals("달러")){
        //     resultAmount = inputAmount * DOLLAR_EXCHANGE_RATE;
        // }else if(monetaryUnit.equals("엔")){
        //     resultAmount = inputAmount * YEN_EXCHANGE_RATE;
        // }else if(monetaryUnit.equals("위안")){
        //     resultAmount = inputAmount * YUAN_EXCHANGE_RATE;
        // }else{
        //     System.out.println("잘못된 화폐단위입니다.");
        // }
